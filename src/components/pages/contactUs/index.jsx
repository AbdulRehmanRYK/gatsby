                    ...
                    <Form>
                        <Row className="m-5" xs={1} md={2} >
                            <Form.Group sm={12} md={6}  controlId="formFName">
                                ...
                                <Form.Control className={styles.cform_control} type="firstname" placeholder="" />
                            </Form.Group>
                            <Form.Group sm={12} md={6}  controlId="formLName">
                                <Form.Label className={styles.cformlabels}>Last Name</Form.Label>
                                <Form.Control className={styles.cform_control} type="lastname" placeholder="" />
                            </Form.Group>
                        ...
                        <Row className="m-5"  xs={1} md={2}>
                             <Form.Group  sm={12} md={6}  className="mb-3" controlId="formEmail">
                                ...
                                <Form.Control className={styles.cform_control}  type="email"  placeholder="" />
                            </Form.Group>
                            <Form.Group sm={12} md={6}  className="mb-3" controlId="formPhno">
                                <Form.Label className={styles.cformlabels}>Phone No</Form.Label>
                                <Form.Control className={styles.cform_control} type="phno" placeholder="" />
                            </Form.Group>
                        </Row>
                        <Row className="m-5"  xs={1} md={2}>
                             <Form.Group  sm={12} md={6}  className="mb-3" controlId="formEmail">
                        ...
                        <Row className="m-5" sm={12}>
                             <Form.Group className="mb-3" controlId="formGridAddress2">
                                ...
                                <Form.Control className={styles.cform_control1} type="msg" placeholder="" />
                            </Form.Group>
                        </Row>
