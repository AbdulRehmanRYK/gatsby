            ...
            <div className={styles.mainWeb}>
                ...
                <Row className={styles.mainRow}   xs={1} sm={2} md={3} lg={4}>
                    <Col lg={3} md={4} sm={6} xs={9}   >
                        ...
                        <StaticImage className={styles.webstatic} src="../../../assets/images/nodejss.png"></StaticImage>
                            <p className={styles.webheading}>NodeJS</p>
                        </div>      
                    </Col>
                    <Col lg={3} md={4} sm={6} xs={9}  >
                        <div className={styles.webblock}>
                        <StaticImage className={styles.webstatic} src="../../../assets/images/Reactt.png"></StaticImage>
                    ...
                    <Col lg={3} md={4} sm={6} xs={9}>
                        <div className={styles.webblock}>
                        <StaticImage className={styles.webstatic} src="../../../assets/images/mongodb.png"></StaticImage>
                    ...
                    <Col lg={3} md={4} sm={6} xs={9}>
                        <div className={styles.webblock}>
                        <StaticImage className={styles.webstatic} src="../../../assets/images/html (1).png"></StaticImage>
                    ...
                    <Col lg={3} md={4} sm={6} xs={9}>
                        <div className={styles.webblock}>
                        <StaticImage className={styles.webstatic} src="../../../assets/images/django.png"></StaticImage>
